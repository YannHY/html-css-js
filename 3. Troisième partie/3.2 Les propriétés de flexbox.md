...
🏠 [[Documentation/HTML-CSS/Cours HTML CSS JS/Index|Index]] > Les propriétés de flexbox

Nous avons vu [[3.1 Flexbox (introduction) | précédemment]] que nous devions avoir un **conteneur flex** contenant des **éléments flex**.
...
![[flex-cross-axis-row.png]]

![[flex-cross-axis-column.png]]
...
![[justify-content-center 1.png | 600]]
...
![[Documentation/HTML-CSS/Cours HTML CSS JS/Images/flex-basis.png | 600]]
...
Toutes les explications sont sur [[Exercice 7 | l'exercice 7]]. Une fois que vous aurez fini (ou que vous vous serez suffisamment entraîné, faites [[Exercice 8 | l'exercice 8]]) où vous appliquerez flex à l'un de nos sites.

➡️ Enfin, passez à la suite, et découvrons [[3.3 Grid (introduction) | grid]].
